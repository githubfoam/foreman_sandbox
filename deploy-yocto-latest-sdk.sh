...
echo "============================build yocto latest revision sdk=============================================================="
...
# To compile applications that require libraries other than glibc 
# build an SDK which contains development versions of all libraries in the rootfs image, 
# and not just the basic toolchain. 
cd ~/var-fslc-yocto
